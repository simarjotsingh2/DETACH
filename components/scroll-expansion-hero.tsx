...
interface ScrollExpandMediaProps {
  ...
  textBlend?: boolean;
  children?: ReactNode; // <- buttons etc.
}
...
const ScrollExpandMedia = ({
  ...
  const [showContent, setShowContent] = useState<boolean>(false); // kept to avoid touching your logic
          ...
          <div className='container mx-auto flex flex-col items-center justify-start relative z-10'>
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                ...
                {/* ✅ Buttons directly under the title, inside the animated card */}
                {children ? (
            ...
            {/* Removed the below-the-hero children section */}
          </div>
        </div>
      </section>
    </div>
